...
public class AppModule {
    ...
    public AIUIRepository provideCenterRepository(Application application
            , @Named("AIUI cfg") JSONObject config, @Named("msc cfg") String mscCfg, MessageDao dao, SettingsRepo settings, AIUIPlayer player) {
//        Log.i("ChatFragment", "AppModule-provideCenterRepository: 配置信息：" + config.toString());
        SpeechCreateIfExists(application, config);
        return new AIUIRepository(application, config, mscCfg, dao, settings, player);
    }
